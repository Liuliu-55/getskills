...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1,32,3,1)        #convolutional layer 1
        self.conv2 == nn.Conv2d(32,64,3,1)      #convolutional layer 2
        self.droupout1 = nn.Dropout(0.25)       #regularzation
        self.droupout2 = nn.Dropout(0.5)        #regularzation 
...
def test(model,device,test_loader):
    ...
    tese_loss /= len(test_loader.dataset)
...
def main():
    ...
    torch.manual_seed(argparse.seed)
